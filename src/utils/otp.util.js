...
<div>
<p>
Please use the above One Time Password (OTP) for your Animal Rescue Network 
account. This OTP is valid for next 5 minutes.
</p>
...
Animal Rescue Network
  ...
  const mailOptions = {
    ...
    to: email,
    subject: `Animal Rescue Network OTP - ${otp}`,
    html: emailHtml,
  };
